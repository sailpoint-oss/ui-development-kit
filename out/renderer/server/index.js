...
import { c as create_ssr_component, s as setContext, v as validate_component, m as missing_component } from './chunks/ssr-pGtI3Kui.js';
...
import { w as writable, r as readable } from './chunks/index2-CcAcUxny.js';
...
async function respond(request, options2, manifest, state) {
  ...
  const event = {
    ...
    getClientAddress: state.getClientAddress || (() => {
      throw new Error(
        `${"adapter-electron"} does not specify getClientAddress. Please raise an issue`
      );
    }),
    locals: {},
    params,
