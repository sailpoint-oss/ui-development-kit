...
export const getAccessRequestConfigV2 = (apiConfig: sdk.Configuration): Promise<ApiResponse<accessRequestsTypes.Accessrequestconfigv2>> => {
    const accessrequestsapi = new sdk.AccessRequestsApi(apiConfig);
...
export const setAccessRequestConfigV2 = (requestParameters: accessRequestsTypes.AccessRequestsApiSetAccessRequestConfigV2Request, apiConfig: sdk.Configuration): Promise<ApiResponse<accessRequestsTypes.Accessrequestconfigv2>> => {
    const accessrequestsapi = new sdk.AccessRequestsApi(apiConfig);
